#!/usr/bin/env python3
"""Fetch Sleeper standings and regenerate teams.html for NFL Rivals A."""
...
# Sleeper username -> folder name in teams/
OWNER_TO_FOLDER = {
    "BMX58": "steelers",
    "mucci22": "bengals",
    "loorich": "lions",
    "VicArthur7": "vikings",
    "LilTissa": "eagles",
    "Mikemooch2323": "giants",
    "Mikestev7": "seahawks",
    "kidrich44": "cardinals",
}
FOLDER_TO_DISPLAY = {
    "steelers": "Steelers", "bengals": "Bengals", "lions": "Lions",
